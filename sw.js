const CACHE='alexandra-lucas-v2-2';
const ASSETS=['./','./index.html','./styles.css?v=2.2','./theme-v22.css?v=2.2','./app.js?v=2.2','./config.js?v=2.2','./manifest.webmanifest?v=2.2','./logo.svg','./logo-al.svg'];
