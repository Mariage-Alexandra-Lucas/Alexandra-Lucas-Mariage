const CACHE='alexandra-lucas-v2-8-1-quiz-sync';
const ASSETS=[
  './','./index.html',
  ...
  './config.js?v=2.4.0','./app.js?v=2.8.0','./ui-v23.js?v=2.4.0','./logo-fix.js?v=2.4.0','./features-v24.js?v=2.8.0','./quiz-v25.js?v=2.8.1','./events-v26.js?v=2.8.0','./performance-v28.js?v=2.8.0',
