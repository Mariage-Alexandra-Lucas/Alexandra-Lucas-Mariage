(() => {
  ...
  function puzzleForm(){return `<div class="wedding-puzzle">
    ...
    <section class="puzzle-block"><h3>2. Retrouvez l’année de chaque photo</h3><div class="puzzle-photos">${[['photo2021','souvenir-2021.jpeg'],['photo2024','souvenir-2024.jpeg'],['photo2015','souvenir-2015.jpeg']].map(([key,src])=>`<label><img src="${src}" alt="Souvenir d’Alexandra et Lucas" loading="lazy" decoding="async"><select class="field" data-puzzle-year="${key}"><option value="">Choisir l’année</option><option>2015</option><option>2021</option><option>2024</option></select></label>`).join('')}</div></section>
